...
Page({
  ...
  submitForm(e) {
    ...
    app.post('userSiteOrder/checkIdCard', data).then(res => {
      wx.showModal({
        title: '提示',
        content: '实名认证成功',
        showCancel: false,
